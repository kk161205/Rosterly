...
export const Sidebar: React.FC<SidebarProps> = ({
  ...
  return (
    <aside className="w-60 bg-primary text-on-primary min-h-screen flex flex-col justify-between border-r border-primary-container shadow-sm select-none flex-shrink-0">
      <div>
        {/* Brand Header */}
        <div className="h-16 px-5 flex items-center justify-between border-b border-primary-container/60">
        ...
        {/* Role Identity Tag */}
        <div className="px-4 py-3 mx-3 my-3 rounded-md bg-primary-container/50 border border-primary-container text-xs flex items-center justify-between">
      ...
      <div className="p-3 border-t border-primary-container/60 space-y-2">
        {unreadAlertsCount > 0 && (
        ...
        <button
          ...
          className="w-full flex items-center gap-3 px-3 py-2 rounded-md text-sm font-medium text-inverse-primary hover:bg-error/20 hover:text-red-200 transition-colors"
        >
